<?php
                        ...
                        $sql="SELECT doc_in.*, us.user_name, ty.*, dep.*
                              ...
                              ORDER BY doc_in.in_id DESC LIMIT {$offset},{$limit}";
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-9">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="col-md-10 float-right">
                      ...
                      <a href="index.php?page=post_in_id&id=<?php echo($rec['in_id']); ?>" class="btn btn-primary" target="_blank">
            ...
            <?php
                        // show pagination
                        $count = "SELECT * FROM tb_doc_incoming";
                        ...
                        if(mysqli_num_rows($row) > 0){
                          ...
                          if($page > 1){
                            echo '<li class="page-item">
                                    <a class="page-link" href="index.php?page=doc-in-list&p='.($page - 1).'" tabindex="-1" aria-disabled="true">Previous</a>
                                  </li>';
                          }
                          for($i = 1; $i <= $total_page; $i++){
                            ...
                            echo '<li class="page-item '.$active.'" aria-current="page">
                                    <a class="page-link" href="index.php?page=doc-in-list&p='.$i.'"> '.$i.' <span class="sr-only">(current)</span></a>
                                  </li>';
                          }
                          if($total_page > $page){
                            echo '<li class="page-item">
                                    <a class="page-link" href="index.php?page=doc-in-list&p='.($page + 1).'">Next</a>
                                  </li>';
                          }
