            ...
            <div class="card-body p-1">
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  ...
                  <form action="do_user.php" id="frm" method="POST">
...
<script>
  $('.del-data').on('click', function(e){
    ...
    Swal.fire({
      title: 'ທ່ານຕ້ອງການລົບຂໍ້ມູນຜູ້ໃຊ້ແທ້ ຫຼືບໍ່?',
      icon: 'warning',
  ...
  $('#del-all').on('click', function(e){
    ...
    Swal.fire({
      title: 'ທ່ານຕ້ອງການລົບຂໍ້ມູນຜູ້ໃຊ້ທັງໝົດ ຫຼືບໍ່?',
      icon: 'warning',
      showCancelButton: true,
      confirmButtonColor: '#3085d6',
      cancelButtonColor: '#d33',
      ...
      const addata = $('.add-data').data('addata')
        if (addata) {
          Swal.fire({
            position: 'center',
            icon: 'success',
            title: 'ບັກທຶກຂໍ້ມູນຜູ້ໃຊ້ສຳເລັດ',
