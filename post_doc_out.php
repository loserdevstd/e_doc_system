                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="col-md-10 float-right">
                      ...
                      <a href="index.php?page=post_out_id&id=<?php echo($rec['out_id']); ?>" class="btn btn-primary" target="_blank">
                  ...
                  <div class="card-footer float-right small">
                      <!-- <a href="#" target="_blank"> -->
                        <i class="fa fa-tags"></i> ເອກະສານຂາອອກ
                      <!-- </a> -->
                      <!-- <a href="#" target="_blank"> -->
                        ...
                        if(mysqli_num_rows($row) > 0){
                          ...
                          if($page > 1){
                            echo '<li class="page-item">
                                    <a class="page-link" href="index.php?page=doc-out-list&p='.($page - 1).'" tabindex="-1" aria-disabled="true">Previous</a>
                                  </li>';
                          }
                          for($i = 1; $i <= $total_page; $i++){
                            ...
                            echo '<li class="page-item '.$active.'" aria-current="page">
                                    <a class="page-link" href="index.php?page=doc-out-list&p='.$i.'"> '.$i.' <span class="sr-only">(current)</span></a>
                                  </li>';
                          }
                          if($total_page > $page){
                            echo '<li class="page-item">
                                    <a class="page-link" href="index.php?page=doc-out-list&p='.($page + 1).'">Next</a>
                                  </li>';
                          }
