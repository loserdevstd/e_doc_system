...
<?php include('doc_type_process.php'); ?>

  <?php $sql=mysqli_query($conn,"SELECT * FROM tb_doctype"); ?>

   <!-- Content Header (Page header) -->
    <section class="content-header">
      <div class="container-fluid">
        <h1>::ຈັດການປະເພດເອກະສານ::</h1>
      </div><!-- /.container-fluid -->
    </section>
    ...
    <section class="content">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">ປະເພດເອກະສານ</h3>
            </div>
            <br>
            <div class="card-body p-1">
              ...
              <div class="row">
                ...
                <div class="col-md-10">
                  <form role="form" method="post" action="doc_type_process.php">
                    <div class="form-group row">
                      <div class="col-sm-7">
                        <input type="text" class="form-control" placeholder="ຊື່ແຟ້ມ" name="type_name" id="tyname"
                          value="<?php echo($tyname); ?>" required>
                      </div>
                    </div>
    ...
    <?php if (isset($_GET['save'])) : ?>
      ...
      <meta http-equiv="refresh" content="1;url=doc_type_list.php">
    <?php endif; ?>
                  ...
                  <table id="example1" class="table table-bordered table-hover" role="grid" aria-describedby="example1_info">
                    <thead>
                      <tr role="row" class="info bg-primary" align="center">
                        ...
                        <th  tabindex="0" rowspan="1" colspan="1" style="width: 20%;">ຊື່ແຟ້ມເອກະສານ</th>
                        <th  tabindex="0" rowspan="1" colspan="1" style="width: 20%;">ຈັດການ</th>  
                      </tr>
                    </thead>
                    <tbody>
                      ...
                      <tr>
                          ...
                          <td>
                            <a class="btn btn-primary btn-sm"
                              href="doc_type_list.php?edit=<?php echo($row['type_id']);?>">
                              <i class="fas fa-pencil-alt"></i> ແກ້ໄຂ</a>
                            <a class="btn btn-danger btn-sm del-type"
                              href="doc_type_process.php?del=<?php echo($row['type_id']);?>">
