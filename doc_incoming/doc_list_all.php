<title>ເອກະສານຂາເຂົ້າ | ລາຍການທັງໝົດ</title>
<?php
  if($user_level==1){
  ...
  <!-- Content Header (Page header) -->
    <section class="content-header">
      <div class="container-fluid">
        <h1>ລາຍການເອກະສານຂາເຂົ້າທັງໝົດ</h1>
      </div><!-- /.container-fluid -->
    </section>
    <!--alert add complete-->
    <?php if (isset($_GET['add'])) : ?>
      <div class="add-data" data-addata="<?= $_GET['add']; ?>"></div>
      <meta http-equiv="refresh" content="1;url=index.php?page=doc-in-all">
    <?php endif; ?>
    ...
    <section class="content">
          ...
          <div class="card">
            <div class="card-header">
              <a href="index.php?page=doc-in-add" class="btn btn-primary">
            ...
            <div class="card-body p-1">
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  ...
                  <form action="do_doc_in.php" id="frm" method="POST">
                  <table id="example1" class="table table-bordered table-hover" role="grid" aria-describedby="example1_info">
                    ...
                    <tbody>
                      ...
                      <tr>
                          <td style="padding-top: 30px">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                              <a class="dropdown-item"
                                  href="index.php?page=doc-detail&doc-in-id=<?php echo($rec['in_id']); ?>"><i
                                    class="fas fa-eye"></i> ລາຍລະອຽດ</a>
                          
                              <a class="dropdown-item"
                                  href="index.php?page=doc-in-edit&id=<?php echo($rec['in_id']); ?>">
                                  <i class="fas fa-edit"></i> 
                                  ແກ້ໄຂ</a>
                             
                                 
                              <a class="dropdown-item delete" 
                                  href="do_doc_in.php?del=<?php echo($rec['in_id']); ?>&type=<?php echo($rec['type_id']); ?>&page=all">
                          ...
                          <td style="padding-top: 30px"><?php echo($rec['in_date']); ?></td>
                          <td style="padding-top: 30px"><?php echo($rec['type_name']); ?></td>
                           <td><?php echo($rec['doc_title']); ?></td>
                           <td style="padding-top: 30px" align="center"><?php echo($rec['doc_id']); ?></td>
                           <td style="padding-top: 30px"><?php echo($rec['doc_date']); ?></td>
